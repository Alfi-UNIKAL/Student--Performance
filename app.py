...
# --- Form input ---
new_ACT = st.number_input("Masukkan nilai ACT composite score:", min_value=0.0)
new_SAT = st.number_input("Masukkan nilai SAT total score:", min_value=0.0)
new_GPA = st.number_input("Masukkan nilai rata-rata SMA:", min_value=0.0)
new_income = st.number_input("Masukkan pendapatan orang tua:", min_value=0.0)
new_education = st.number_input("Masukkan tingkat pendidikan orang tua (angka):", min_value=0.0)
